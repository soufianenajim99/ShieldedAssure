...
<body class="h-screen">
    ...
    <div class="navbar bg-base-100">
        ...
        <div class="navbar-center">
            <a class="btn btn-ghost text-xl">ShieldedAssurence</a>
        </div>
    ...
    <aside class="fixed top-0 left-0 w-1/5 h-full" aria-label="Sidenav">
        <div
            class="overflow-y-auto py-3 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <ul class="space-y-2">
                <li class="py-3">
                    <a href="#"
                ...
                <li>
                    <a href="bank.php"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Banks</span>
                    </a>
                </li>
                <li>
                    <a href="Users.php"
                ...
                <li>
                    <a href="Distributer.php"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Distributeur</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="Agency.php"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Agency</span>
                    </a>
                </li>
                <li>
                    <button type="button"
