...
<body class="h-screen">
    <div class="navbar bg-base-100 w-4/5 float-right">
        ...
        <div class="navbar-center">
            <a class="btn btn-ghost text-xl" href="../../../index.php">E-Bank</a>
        </div>
    ...
    <!-- menuu -->
    <div class="menu-container w-4/5 flex flex-row justify-center items-center float-right">
