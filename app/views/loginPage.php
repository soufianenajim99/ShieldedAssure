...
<body>
    ...
    <div class="bg-no-repeat bg-cover bg-center relative"
        ...
        <div class="absolute bg-gradient-to-b from-gray-500 to-gray-400 opacity-75 inset-0 z-0"></div>
        <div class="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
            <div class="flex-col flex  self-center p-10 sm:max-w-5xl xl:max-w-2xl  z-10">
                <div class="self-start hidden lg:flex flex-col  text-white">
                    <img src="" class="mb-3">
                    <h1 class="mb-3 font-bold text-5xl">Get Started With ShieldedAssure</h1>
            ...
            <div class="flex justify-center self-center  z-10">
                <div class="p-12 bg-white mx-auto rounded-2xl w-100 ">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <button type="submit"
                                class="w-full flex justify-center bg-gray-400  hover:bg-gray-500 text-gray-100 p-3  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                                Sign in
                            </button>
                        </div>
                    </div>
                    <div class="pt-5 text-center text-gray-400 text-xs">
                        <span>
                            ...
                            <a href="https://codepen.io/uidesignhub" rel="" target="_blank" title="Ajimon"
                                class="text-gray hover:text-gray-500 ">Soufiane</a></span>
                    </div>
                </div>
            </div>
        </div>
